...
package com.zahab.cryptotracker.crypto.presentation.coin_detail
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value / 100))
                        .toDisplayPriceNumber()

                val isPositive = coin.changePercent24Hr.value > 0.0
                val contentColorLast24Hrs = if (isPositive) {
                ...
                InfoCard(
                    ...
                    contentColor = contentColorLast24Hrs
